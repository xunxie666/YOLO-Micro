...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt', default='E:\\PyCharm2022.1.3\\PycharmProjects\\yolov7-main\\yolov7.pt', type=str, help='ckpt path')
    parser.add_argument('--device', type=str, default='0', help='gpu device,0,1,2..., or cpu')
    parser.add_argument('--yaml_path', type=str, default='E:\\PyCharm2022.1.3\\PycharmProjects\\yolov7-main\cfg\\training\\yolov7.yaml', help='yaml file path')
