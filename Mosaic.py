...
def get_random_data(image_list, input_shape):
    ...
    cv2.imshow('Mosaic', final_image_copy)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.imshow('Mosaic', modify_image_copy)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
...
if __name__ == '__main__':
    ...
    # 给出图片文件夹和检测框文件夹所在的位置
    image_dir = 'E:\\PyCharm2022.1.3\\PycharmProjects\\yolov7-main\\data\\VOC2007\\images\\'
    annotation_dir = 'E:\\PyCharm2022.1.3\\PycharmProjects\\yolov7-main\\data\\VOC2007\\annotation\\'
    ...
    # 缩放、拼接图片
    get_random_data(image_list, input_shape=[512, 512])
